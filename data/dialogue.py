...
Особенности коллекции «Soviet Neko»:
— Старт продаж в первую минуту после запуска VK NFT Маркетплейса;
— 322 уникальных токена различной степени редкости;
— 16 уникальных параметров, таких как пол персонажа или время суток;
— Уникальные словесные описания каждого токена;
— Минимальная стоимость NFT в коллекции 300 рублей. Оплатить NFT можно будет картой любого российского банка. Для приема платежей будет использоваться VK Pay;
— Все токены предварительно заминчены. Вы покупаете именно тот NFT, который вам понравился;
— Владельцы NFT из новой коллекции получат все те же привилегии, что и владельцы основной коллекции.
